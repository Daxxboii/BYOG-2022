    ...
    public class PlayerController : MonoBehaviour
    {
       ...
       /* public override void OnNetworkSpawn(){
        ...
        private void CamMovements()
        {
            ...
            CamRot.x = _xRotation;
            CamRot.z = 0;
            Cam.transform.eulerAngles = CamRot;//Quaternion.Euler(_xRotation,transform.rotation.y, 0);
        ...
        private void SampleGround()
        {
            ...
            RaycastHit hitInfo;
            //Debug.DrawRay(_playerRigidbody.worldCenterOfMass, Vector3.down,Color.red,Mathf.Infinity);
