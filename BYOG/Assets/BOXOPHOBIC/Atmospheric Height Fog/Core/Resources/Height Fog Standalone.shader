	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 temp_output_216_0_g973 = ( _WorldSpaceCameraPos - ( eyeDepth218_g973 * ( ( _WorldSpaceCameraPos - ase_worldPos ) / computeScreenPos225_g973.w ) ) );
				float3 WorldPositionFromDepth253_g973 = temp_output_216_0_g973;
				...
				float DirectionalMask30_g973 = pow( abs( ( (dotResult145_g973*0.5 + 0.5) * _DirectionalIntensity ) ) , _DirectionalFalloff );
				...
				float3 gammaToLinear3_g979 = FastSRGBToLinear( temp_output_2_0_g979 );
				...
				float saferPower309_g973 = max( abs( saturate( ( ( abs( ( ( break170_g973.x + break170_g973.y + break170_g973.z ) + -_SkyboxFogOffset ) ) - temp_output_7_0_g977 ) / ( 0.0 - temp_output_7_0_g977 ) ) ) ) , 0.0001 );
				...
				surfaceDescription.Color = temp_output_256_0_g973;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = temp_output_43_0_g973;
...
WireConnection;1120;6;1119;445
ASEEND*/
//CHKSM=919371AB4651D28E09E48671A2B3C68B0F62F3F0