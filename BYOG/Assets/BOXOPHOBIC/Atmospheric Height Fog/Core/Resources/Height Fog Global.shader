	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float eyeDepth218_g963 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 unityObjectToClipPos224_g963 = TransformWorldToHClip(TransformObjectToWorld(packedInput.ase_texcoord2.xyz));
				float4 computeScreenPos225_g963 = ComputeScreenPos( unityObjectToClipPos224_g963 , _ProjectionParams.x );
				float3 temp_output_216_0_g963 = ( _WorldSpaceCameraPos - ( eyeDepth218_g963 * ( ( _WorldSpaceCameraPos - ase_worldPos ) / computeScreenPos225_g963.w ) ) );
				float3 WorldPositionFromDepth253_g963 = temp_output_216_0_g963;
				float3 WorldPosition2_g963 = WorldPositionFromDepth253_g963;
				float temp_output_7_0_g968 = AHF_FogDistanceStart;
				half FogDistanceMask12_g963 = pow( abs( saturate( ( ( distance( WorldPosition2_g963 , _WorldSpaceCameraPos ) - temp_output_7_0_g968 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g968 ) ) ) ) , AHF_FogDistanceFalloff );
				float3 lerpResult258_g963 = lerp( (AHF_FogColorStart).rgb , (AHF_FogColorEnd).rgb , ( saturate( ( FogDistanceMask12_g963 - 0.5 ) ) * AHF_FogColorDuo ));
				float3 normalizeResult318_g963 = normalize( ( WorldPosition2_g963 - _WorldSpaceCameraPos ) );
				float dotResult145_g963 = dot( normalizeResult318_g963 , AHF_DirectionalDir );
				float DirectionalMask30_g963 = pow( abs( ( (dotResult145_g963*0.5 + 0.5) * AHF_DirectionalIntensity ) ) , AHF_DirectionalFalloff );
				float3 lerpResult40_g963 = lerp( lerpResult258_g963 , (AHF_DirectionalColor).rgb , DirectionalMask30_g963);
				#ifdef AHF_DISABLE_DIRECTIONAL
				float3 staticSwitch442_g963 = lerpResult258_g963;
				#else
				float3 staticSwitch442_g963 = lerpResult40_g963;
				#endif
				float3 temp_output_2_0_g969 = staticSwitch442_g963;
				float3 gammaToLinear3_g969 = FastSRGBToLinear( temp_output_2_0_g969 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g969 = temp_output_2_0_g969;
				#else
				float3 staticSwitch1_g969 = gammaToLinear3_g969;
				#endif
				float3 temp_output_256_0_g963 = staticSwitch1_g969;
				
				half3 AHF_FogAxisOption181_g963 = AHF_FogAxisOption;
				float3 break159_g963 = ( WorldPosition2_g963 * AHF_FogAxisOption181_g963 );
				float temp_output_7_0_g966 = AHF_FogHeightEnd;
				half FogHeightMask16_g963 = pow( abs( saturate( ( ( ( break159_g963.x + break159_g963.y + break159_g963.z ) - temp_output_7_0_g966 ) / ( AHF_FogHeightStart - temp_output_7_0_g966 ) ) ) ) , AHF_FogHeightFalloff );
				float lerpResult328_g963 = lerp( ( FogDistanceMask12_g963 * FogHeightMask16_g963 ) , saturate( ( FogDistanceMask12_g963 + FogHeightMask16_g963 ) ) , AHF_FogLayersMode);
				float mulTime204_g963 = _TimeParameters.x * 2.0;
				float3 temp_output_197_0_g963 = ( ( WorldPosition2_g963 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * mulTime204_g963 ) );
				float3 p1_g965 = temp_output_197_0_g963;
				float localSimpleNoise3D1_g965 = SimpleNoise3D( p1_g965 );
				float temp_output_7_0_g964 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g963 = saturate( ( ( distance( WorldPosition2_g963 , _WorldSpaceCameraPos ) - temp_output_7_0_g964 ) / ( 0.0 - temp_output_7_0_g964 ) ) );
				float lerpResult198_g963 = lerp( 1.0 , (localSimpleNoise3D1_g965*0.5 + 0.5) , ( NoiseDistanceMask7_g963 * AHF_NoiseIntensity ));
				half NoiseSimplex3D24_g963 = lerpResult198_g963;
				#ifdef AHF_DISABLE_NOISE3D
				float staticSwitch42_g963 = lerpResult328_g963;
				#else
				float staticSwitch42_g963 = ( lerpResult328_g963 * NoiseSimplex3D24_g963 );
				#endif
				float3 normalizeResult169_g963 = normalize( ( WorldPosition2_g963 - _WorldSpaceCameraPos ) );
				float3 break170_g963 = ( normalizeResult169_g963 * AHF_FogAxisOption181_g963 );
				float temp_output_7_0_g967 = AHF_SkyboxFogHeight;
				float saferPower309_g963 = max( abs( saturate( ( ( abs( ( ( break170_g963.x + break170_g963.y + break170_g963.z ) + -AHF_SkyboxFogOffset ) ) - temp_output_7_0_g967 ) / ( 0.0 - temp_output_7_0_g967 ) ) ) ) , 0.0001 );
				float lerpResult179_g963 = lerp( pow( saferPower309_g963 , AHF_SkyboxFogFalloff ) , 1.0 , AHF_SkyboxFogFill);
				half SkyboxFogHeightMask108_g963 = ( lerpResult179_g963 * AHF_SkyboxFogIntensity );
				float clampDepth118_g963 = SampleCameraDepth( ase_screenPosNorm.xy );
				#ifdef UNITY_REVERSED_Z
				float staticSwitch123_g963 = clampDepth118_g963;
				#else
				float staticSwitch123_g963 = ( 1.0 - clampDepth118_g963 );
				#endif
				half SkyboxMask95_g963 = ( 1.0 - ceil( staticSwitch123_g963 ) );
				float lerpResult112_g963 = lerp( staticSwitch42_g963 , SkyboxFogHeightMask108_g963 , SkyboxMask95_g963);
				float temp_output_43_0_g963 = ( lerpResult112_g963 * AHF_FogIntensity );
				
				surfaceDescription.Color = temp_output_256_0_g963;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = temp_output_43_0_g963;
...
/*ASEBEGIN
Version=18909
1920;1;1906;1021;4059.594;5110.538;1;True;False
