	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = vertexToFrag11_g52308;
				float2 lerpResult1545_g51727 = lerp( inputMesh.ase_texcoord.xy , inputMesh.uv1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g51727 = lerpResult1545_g51727;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float2 staticSwitch3466_g51727 = (ase_worldPos).xz;
				#else
				float2 staticSwitch3466_g51727 = lerpResult1545_g51727;
				#endif
				float2 vertexToFrag11_g52243 = ( ( staticSwitch3466_g51727 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.zw = vertexToFrag11_g52243;
				half Mesh_DetailMask90_g51727 = inputMesh.ase_color.b;
				float vertexToFrag11_g52208 = ( ( Mesh_DetailMask90_g51727 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord6.x = vertexToFrag11_g52208;
				...
				float3 vertexToFrag3890_g51727 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag3890_g51727;
				
				float2 vertexToFrag11_g52248 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = vertexToFrag11_g52248;
						...
						)
			{
				...
				float2 vertexToFrag11_g52308 = packedInput.ase_texcoord5.xy;
				half2 Main_UVs15_g51727 = vertexToFrag11_g52308;
				float4 tex2DNode29_g51727 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51727 );
				float3 temp_output_51_0_g51727 = ( (_MainColor).rgb * (tex2DNode29_g51727).rgb );
				half3 Main_Albedo99_g51727 = temp_output_51_0_g51727;
				float2 vertexToFrag11_g52243 = packedInput.ase_texcoord5.zw;
				half2 Second_UVs17_g51727 = vertexToFrag11_g52243;
				half3 Second_Albedo153_g51727 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g51727 ) )).rgb;
				float vertexToFrag11_g52208 = packedInput.ase_texcoord6.x;
				float temp_output_3919_0_g51727 = vertexToFrag11_g52208;
				float3 unpack4112_g51727 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g51727 ), _MainNormalValue );
				unpack4112_g51727.z = lerp( 1, unpack4112_g51727.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g51727 = unpack4112_g51727;
				...
				float3 tanNormal4099_g51727 = Main_Normal137_g51727;
				float3 worldNormal4099_g51727 = float3(dot(tanToWorld0,tanNormal4099_g51727), dot(tanToWorld1,tanNormal4099_g51727), dot(tanToWorld2,tanNormal4099_g51727));
				float3 Main_Normal_WS4101_g51727 = worldNormal4099_g51727;
				float lerpResult1537_g51727 = lerp( Main_Normal_WS4101_g51727.y , -Main_Normal_WS4101_g51727.y , _DetailProjectionMode);
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float staticSwitch3467_g51727 = temp_output_3919_0_g51727;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				float staticSwitch3467_g51727 = ( ( lerpResult1537_g51727 * 0.5 ) + _DetailMeshValue );
				#else
				float staticSwitch3467_g51727 = temp_output_3919_0_g51727;
				#endif
				half Blend_Source1540_g51727 = staticSwitch3467_g51727;
				float4 tex2DNode35_g51727 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g51727 );
				half Main_Mask57_g51727 = tex2DNode35_g51727.b;
				float4 tex2DNode33_g51727 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_SecondMaskTex, Second_UVs17_g51727 );
				half Second_Mask81_g51727 = tex2DNode33_g51727.b;
				float lerpResult1327_g51727 = lerp( Main_Mask57_g51727 , Second_Mask81_g51727 , _DetailMaskMode);
				float lerpResult4058_g51727 = lerp( lerpResult1327_g51727 , ( 1.0 - lerpResult1327_g51727 ) , _DetailMaskInvertMode);
				float temp_output_7_0_g52238 = _DetailBlendMinValue;
				half Mask_Detail147_g51727 = saturate( ( ( saturate( ( Blend_Source1540_g51727 + ( Blend_Source1540_g51727 * lerpResult4058_g51727 ) ) ) - temp_output_7_0_g52238 ) / ( _DetailBlendMaxValue - temp_output_7_0_g52238 ) ) );
				float3 lerpResult235_g51727 = lerp( Main_Albedo99_g51727 , ( Main_Albedo99_g51727 * Second_Albedo153_g51727 * 4.594794 ) , Mask_Detail147_g51727);
				float3 lerpResult208_g51727 = lerp( Main_Albedo99_g51727 , Second_Albedo153_g51727 , Mask_Detail147_g51727);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g51727 = lerpResult235_g51727;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g51727 = lerpResult208_g51727;
				#else
				float3 staticSwitch4062_g51727 = lerpResult235_g51727;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch255_g51727 = Main_Albedo99_g51727;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch255_g51727 = staticSwitch4062_g51727;
				#else
				float3 staticSwitch255_g51727 = Main_Albedo99_g51727;
				#endif
				half3 Blend_Albedo265_g51727 = staticSwitch255_g51727;
				half3 Blend_AlbedoTinted2808_g51727 = ( float3(1,1,1) * float3(1,1,1) * float3(1,1,1) * Blend_Albedo265_g51727 );
				half3 Blend_AlbedoColored863_g51727 = Blend_AlbedoTinted2808_g51727;
				half3 Blend_AlbedoAndSubsurface149_g51727 = Blend_AlbedoColored863_g51727;
				half3 Global_OverlayColor1758_g51727 = (TVE_OverlayColor).rgb;
				float lerpResult3567_g51727 = lerp( _OverlayBottomValue , 1.0 , Main_Normal_WS4101_g51727.y);
				half Main_AlbedoTex_G3526_g51727 = tex2DNode29_g51727.g;
				half Second_AlbedoTex_G3581_g51727 = (SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g51727 )).g;
				float lerpResult3579_g51727 = lerp( Main_AlbedoTex_G3526_g51727 , Second_AlbedoTex_G3581_g51727 , Mask_Detail147_g51727);
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch3574_g51727 = Main_AlbedoTex_G3526_g51727;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch3574_g51727 = lerpResult3579_g51727;
				#else
				float staticSwitch3574_g51727 = Main_AlbedoTex_G3526_g51727;
				#endif
				float3 vertexToFrag3890_g51727 = packedInput.ase_texcoord7.xyz;
				float3 PositionWS_PerVertex3905_g51727 = vertexToFrag3890_g51727;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g51727;
				...
				half Global_Extras_Overlay156_g51727 = break89_g52261.b;
				float temp_output_1025_0_g51727 = ( _GlobalOverlay * Global_Extras_Overlay156_g51727 );
				half Overlay_Commons1365_g51727 = temp_output_1025_0_g51727;
				float temp_output_7_0_g52234 = _OverlayMaskMinValue;
				half Overlay_Mask269_g51727 = saturate( ( ( ( ( ( lerpResult3567_g51727 * 0.5 ) + staticSwitch3574_g51727 ) * Overlay_Commons1365_g51727 ) - temp_output_7_0_g52234 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g52234 ) ) );
				float3 lerpResult336_g51727 = lerp( Blend_AlbedoAndSubsurface149_g51727 , Global_OverlayColor1758_g51727 , Overlay_Mask269_g51727);
				half3 Final_Albedo359_g51727 = lerpResult336_g51727;
				
				float3 unpack4114_g51727 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_SecondMaskTex, Second_UVs17_g51727 ), _SecondNormalValue );
				unpack4114_g51727.z = lerp( 1, unpack4114_g51727.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g51727 = unpack4114_g51727;
				float3 lerpResult230_g51727 = lerp( float3( 0,0,1 ) , Second_Normal179_g51727 , Mask_Detail147_g51727);
				float3 lerpResult3372_g51727 = lerp( float3( 0,0,1 ) , Main_Normal137_g51727 , _DetailNormalValue);
				float3 lerpResult3376_g51727 = lerp( Main_Normal137_g51727 , BlendNormal( lerpResult3372_g51727 , Second_Normal179_g51727 ) , Mask_Detail147_g51727);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g51727 = BlendNormal( Main_Normal137_g51727 , lerpResult230_g51727 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g51727 = lerpResult3376_g51727;
				#else
				float3 staticSwitch4063_g51727 = BlendNormal( Main_Normal137_g51727 , lerpResult230_g51727 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch267_g51727 = Main_Normal137_g51727;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g51727 = staticSwitch4063_g51727;
				#else
				float3 staticSwitch267_g51727 = Main_Normal137_g51727;
				#endif
				float3 temp_output_13_0_g52210 = staticSwitch267_g51727;
				float3 switchResult12_g52210 = (((isFrontFace>0)?(temp_output_13_0_g52210):(( temp_output_13_0_g52210 * _render_normals_options ))));
				half3 Blend_Normal312_g51727 = switchResult12_g52210;
				half3 Final_Normal366_g51727 = Blend_Normal312_g51727;
				
				half Main_Metallic237_g51727 = ( tex2DNode35_g51727.r * _MainMetallicValue );
				half Second_Metallic226_g51727 = ( tex2DNode33_g51727.r * _SecondMetallicValue );
				float lerpResult278_g51727 = lerp( Main_Metallic237_g51727 , Second_Metallic226_g51727 , Mask_Detail147_g51727);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4064_g51727 = Main_Metallic237_g51727;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4064_g51727 = lerpResult278_g51727;
				#else
				float staticSwitch4064_g51727 = Main_Metallic237_g51727;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch299_g51727 = Main_Metallic237_g51727;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch299_g51727 = staticSwitch4064_g51727;
				#else
				float staticSwitch299_g51727 = Main_Metallic237_g51727;
				#endif
				half Blend_Metallic306_g51727 = staticSwitch299_g51727;
				float lerpResult342_g51727 = lerp( Blend_Metallic306_g51727 , 0.0 , Overlay_Mask269_g51727);
				half Final_Metallic367_g51727 = lerpResult342_g51727;
				
				float3 hdEmission4189_g51727 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g52248 = packedInput.ase_texcoord8.xy;
				half2 Emissive_UVs2468_g51727 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g51727 = break89_g52261.r;
				float lerpResult4206_g51727 = lerp( 1.0 , Global_Extras_Emissive4203_g51727 , _GlobalEmissive);
				half3 Final_Emissive2476_g51727 = ( (( hdEmission4189_g51727 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51727 ) )).rgb * lerpResult4206_g51727 );
				
				half Main_Smoothness227_g51727 = ( tex2DNode35_g51727.a * _MainSmoothnessValue );
				half Second_Smoothness236_g51727 = ( tex2DNode33_g51727.a * _SecondSmoothnessValue );
				float lerpResult266_g51727 = lerp( Main_Smoothness227_g51727 , Second_Smoothness236_g51727 , Mask_Detail147_g51727);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g51727 = Main_Smoothness227_g51727;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g51727 = lerpResult266_g51727;
				#else
				float staticSwitch4065_g51727 = Main_Smoothness227_g51727;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch297_g51727 = Main_Smoothness227_g51727;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g51727 = staticSwitch4065_g51727;
				#else
				float staticSwitch297_g51727 = Main_Smoothness227_g51727;
				#endif
				half Blend_Smoothness314_g51727 = staticSwitch297_g51727;
				half Global_OverlaySmoothness311_g51727 = TVE_OverlaySmoothness;
				float lerpResult343_g51727 = lerp( Blend_Smoothness314_g51727 , Global_OverlaySmoothness311_g51727 , Overlay_Mask269_g51727);
				half Final_Smoothness371_g51727 = lerpResult343_g51727;
				half Global_Extras_Wetness305_g51727 = break89_g52261.g;
				float lerpResult3673_g51727 = lerp( 0.0 , Global_Extras_Wetness305_g51727 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g51727 = saturate( ( Final_Smoothness371_g51727 + lerpResult3673_g51727 ) );
				
				float lerpResult240_g51727 = lerp( 1.0 , tex2DNode35_g51727.g , _MainOcclusionValue);
				half Main_Occlusion247_g51727 = lerpResult240_g51727;
				float lerpResult239_g51727 = lerp( 1.0 , tex2DNode33_g51727.g , _SecondOcclusionValue);
				half Second_Occlusion251_g51727 = lerpResult239_g51727;
				float lerpResult294_g51727 = lerp( Main_Occlusion247_g51727 , Second_Occlusion251_g51727 , Mask_Detail147_g51727);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g51727 = Main_Occlusion247_g51727;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g51727 = lerpResult294_g51727;
				#else
				float staticSwitch4066_g51727 = Main_Occlusion247_g51727;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float staticSwitch310_g51727 = Main_Occlusion247_g51727;
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g51727 = staticSwitch4066_g51727;
				#else
				float staticSwitch310_g51727 = Main_Occlusion247_g51727;
				#endif
				half Blend_Occlusion323_g51727 = staticSwitch310_g51727;
				
				float localCustomAlphaClip3735_g51727 = ( 0.0 );
				half Final_AlphaFade3727_g51727 = 1.0;
				float Main_Alpha316_g51727 = ( _MainColor.a * tex2DNode29_g51727.a );
				half AlphaTreshold2132_g51727 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g51727 = ( Main_Alpha316_g51727 - ( AlphaTreshold2132_g51727 - 0.5 ) );
				#else
				float staticSwitch3792_g51727 = Main_Alpha316_g51727;
				#endif
				half Final_Alpha3754_g51727 = staticSwitch3792_g51727;
				float temp_output_661_0_g51727 = ( Final_AlphaFade3727_g51727 * Final_Alpha3754_g51727 );
				float Alpha3735_g51727 = temp_output_661_0_g51727;
				float Treshold3735_g51727 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g51727 - Treshold3735_g51727);
				#endif
				}
				half Final_Clip914_g51727 = saturate( Alpha3735_g51727 );
				
				surfaceDescription.Albedo = Final_Albedo359_g51727;
				surfaceDescription.Normal = Final_Normal366_g51727;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = Final_Metallic367_g51727;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = Final_Emissive2476_g51727;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g51727;
				surfaceDescription.Occlusion = Blend_Occlusion323_g51727;
				surfaceDescription.Alpha = Final_Clip914_g51727;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord.xy = vertexToFrag11_g52308;
				float2 lerpResult1545_g51727 = lerp( inputMesh.uv0.xy , inputMesh.uv1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g51727 = lerpResult1545_g51727;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				#endif
				float2 vertexToFrag11_g52243 = ( ( staticSwitch3466_g51727 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord.zw = vertexToFrag11_g52243;
				half Mesh_DetailMask90_g51727 = inputMesh.ase_color.b;
				float vertexToFrag11_g52208 = ( ( Mesh_DetailMask90_g51727 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord1.x = vertexToFrag11_g52208;
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				...
				float3 vertexToFrag3890_g51727 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g51727;
				
				float2 vertexToFrag11_g52248 = ( ( inputMesh.uv0.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.xy = vertexToFrag11_g52248;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 vertexToFrag11_g52308 = packedInput.ase_texcoord.xy;
				half2 Main_UVs15_g51727 = vertexToFrag11_g52308;
				float4 tex2DNode29_g51727 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51727 );
				float3 temp_output_51_0_g51727 = ( (_MainColor).rgb * (tex2DNode29_g51727).rgb );
				half3 Main_Albedo99_g51727 = temp_output_51_0_g51727;
				float2 vertexToFrag11_g52243 = packedInput.ase_texcoord.zw;
				half2 Second_UVs17_g51727 = vertexToFrag11_g52243;
				half3 Second_Albedo153_g51727 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g51727 ) )).rgb;
				float vertexToFrag11_g52208 = packedInput.ase_texcoord1.x;
				float temp_output_3919_0_g51727 = vertexToFrag11_g52208;
				float3 unpack4112_g51727 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g51727 ), _MainNormalValue );
				unpack4112_g51727.z = lerp( 1, unpack4112_g51727.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g51727 = unpack4112_g51727;
				...
				float staticSwitch3574_g51727 = Main_AlbedoTex_G3526_g51727;
				#endif
				float3 vertexToFrag3890_g51727 = packedInput.ase_texcoord4.xyz;
				float3 PositionWS_PerVertex3905_g51727 = vertexToFrag3890_g51727;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g51727;
				float temp_output_84_0_g52261 = _LayerExtrasValue;
				float4 lerpResult88_g52261 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g52261).xz ) ),temp_output_84_0_g52261 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g52261]);
				...
				float3 hdEmission4189_g51727 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g52248 = packedInput.ase_texcoord5.xy;
				half2 Emissive_UVs2468_g51727 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g51727 = break89_g52261.r;
				float lerpResult4206_g51727 = lerp( 1.0 , Global_Extras_Emissive4203_g51727 , _GlobalEmissive);
				half3 Final_Emissive2476_g51727 = ( (( hdEmission4189_g51727 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51727 ) )).rgb * lerpResult4206_g51727 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 vertexToFrag11_g52308 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord1.xy = vertexToFrag11_g52308;
					...
					)
			{
				...
				float localCustomAlphaClip3735_g51727 = ( 0.0 );
				half Final_AlphaFade3727_g51727 = 1.0;
				float2 vertexToFrag11_g52308 = packedInput.ase_texcoord1.xy;
				half2 Main_UVs15_g51727 = vertexToFrag11_g52308;
				float4 tex2DNode29_g51727 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51727 );
				float Main_Alpha316_g51727 = ( _MainColor.a * tex2DNode29_g51727.a );
				half AlphaTreshold2132_g51727 = _Cutoff;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 lerpResult1545_g51727 = lerp( inputMesh.ase_texcoord.xy , inputMesh.ase_texcoord1.xy , _DetailCoordMode);
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				#if defined(TVE_DETAIL_TYPE_VERTEX_BLUE)
				float2 staticSwitch3466_g51727 = lerpResult1545_g51727;
				#elif defined(TVE_DETAIL_TYPE_PROJECTION)
				...
				#endif
				float2 vertexToFrag11_g52243 = ( ( staticSwitch3466_g51727 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord3.zw = vertexToFrag11_g52243;
				half Mesh_DetailMask90_g51727 = inputMesh.ase_color.b;
				float vertexToFrag11_g52208 = ( ( Mesh_DetailMask90_g51727 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord4.x = vertexToFrag11_g52208;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * unity_WorldTransformParams.w;
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
				...
				float3 vertexToFrag3890_g51727 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag3890_g51727;
					...
					)
			{
				...
				unpack4112_g51727.z = lerp( 1, unpack4112_g51727.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g51727 = unpack4112_g51727;
				float2 vertexToFrag11_g52243 = packedInput.ase_texcoord3.zw;
				half2 Second_UVs17_g51727 = vertexToFrag11_g52243;
				float3 unpack4114_g51727 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_SecondMaskTex, Second_UVs17_g51727 ), _SecondNormalValue );
				unpack4114_g51727.z = lerp( 1, unpack4114_g51727.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g51727 = unpack4114_g51727;
				float vertexToFrag11_g52208 = packedInput.ase_texcoord4.x;
				float temp_output_3919_0_g51727 = vertexToFrag11_g52208;
				...
				float staticSwitch3574_g51727 = Main_AlbedoTex_G3526_g51727;
				#endif
				float3 vertexToFrag3890_g51727 = packedInput.ase_texcoord5.xyz;
				float3 PositionWS_PerVertex3905_g51727 = vertexToFrag3890_g51727;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g51727;
				float temp_output_84_0_g52261 = _LayerExtrasValue;
				float4 lerpResult88_g52261 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g52261).xz ) ),temp_output_84_0_g52261 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g52261]);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				#endif
				float2 vertexToFrag11_g52243 = ( ( staticSwitch3466_g51727 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord7.zw = vertexToFrag11_g52243;
				half Mesh_DetailMask90_g51727 = inputMesh.ase_color.b;
				float vertexToFrag11_g52208 = ( ( Mesh_DetailMask90_g51727 - 0.5 ) + _DetailMeshValue );
				outputPackedVaryingsMeshToPS.ase_texcoord8.x = vertexToFrag11_g52208;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * unity_WorldTransformParams.w;
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
				...
				float3 vertexToFrag3890_g51727 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g51727;
				
				float2 vertexToFrag11_g52248 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord10.xy = vertexToFrag11_g52248;
						...
						)
			{
				...
				float3 temp_output_51_0_g51727 = ( (_MainColor).rgb * (tex2DNode29_g51727).rgb );
				half3 Main_Albedo99_g51727 = temp_output_51_0_g51727;
				float2 vertexToFrag11_g52243 = packedInput.ase_texcoord7.zw;
				half2 Second_UVs17_g51727 = vertexToFrag11_g52243;
				half3 Second_Albedo153_g51727 = (( _SecondColor * SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondMaskTex, Second_UVs17_g51727 ) )).rgb;
				float vertexToFrag11_g52208 = packedInput.ase_texcoord8.x;
				float temp_output_3919_0_g51727 = vertexToFrag11_g52208;
				float3 unpack4112_g51727 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g51727 ), _MainNormalValue );
				unpack4112_g51727.z = lerp( 1, unpack4112_g51727.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g51727 = unpack4112_g51727;
				...
				float staticSwitch3574_g51727 = Main_AlbedoTex_G3526_g51727;
				#endif
				float3 vertexToFrag3890_g51727 = packedInput.ase_texcoord9.xyz;
				float3 PositionWS_PerVertex3905_g51727 = vertexToFrag3890_g51727;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g51727;
				float temp_output_84_0_g52261 = _LayerExtrasValue;
				float4 lerpResult88_g52261 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g52261).xz ) ),temp_output_84_0_g52261 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g52261]);
				...
				float3 hdEmission4189_g51727 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g52248 = packedInput.ase_texcoord10.xy;
				half2 Emissive_UVs2468_g51727 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g51727 = break89_g52261.r;
				float lerpResult4206_g51727 = lerp( 1.0 , Global_Extras_Emissive4203_g51727 , _GlobalEmissive);
				half3 Final_Emissive2476_g51727 = ( (( hdEmission4189_g51727 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51727 ) )).rgb * lerpResult4206_g51727 );
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2610.445;815.538;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;341;-2176,384;Inherit;False;Define TVE VERTEX DATA BATCHED;-1;;52314;749c61e1189c7f8408d9e6db94560d1d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;343;-1856,384;Inherit;False;Define TVE IS OBJECT SHADER;-1;;52313;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;406;-1344,-896;Inherit;False;Compile All Shaders;-1;;52312;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;405;-1568,384;Inherit;False;Define PIPELINE HD;-1;;52311;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
ASEEND*/
//CHKSM=5E4CF382DF39FFB7B03CF70C3984FBD46A069202
