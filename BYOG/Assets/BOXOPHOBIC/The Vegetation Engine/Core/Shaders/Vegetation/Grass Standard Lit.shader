	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 PositionOS3588_g51941 = inputMesh.positionOS;
				half3 _Vector1 = half3(0,0,0);
				half3 Off19_g52249 = _Vector1;
				float3 appendResult2827_g51941 = (float3(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord3.w , inputMesh.ase_texcoord.w));
				half3 Mesh_PivotsData2831_g51941 = ( appendResult2827_g51941 * _VertexPivotMode );
				half3 On20_g52249 = Mesh_PivotsData2831_g51941;
				...
				#endif
				half3 Mesh_PivotsOS2291_g51941 = staticSwitch14_g52250;
				...
				half Mesh_Motion_182_g51941 = inputMesh.ase_texcoord3.x;
				...
				half Mesh_Motion_3144_g51941 = inputMesh.ase_texcoord3.z;
				...
				float3 Vertex_Motion_World1118_g51941 = ( ( temp_output_3474_0_g51941 + appendResult2043_g51941 ) + Motion_Detail263_g51941 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g52287 = ObjectPosition_UNITY_MATRIX_M();
				half3 Off19_g52288 = localObjectPosition_UNITY_MATRIX_M14_g52287;
				float3 appendResult93_g52287 = (float3(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord3.w , inputMesh.ase_texcoord.w));
				...
				half3 On20_g52288 = ( localObjectPosition_UNITY_MATRIX_M14_g52287 + PivotsOnly105_g52287 );
				#ifdef TVE_PIVOT_DATA_BAKED
				float3 staticSwitch14_g52288 = On20_g52288;
				#else
				float3 staticSwitch14_g52288 = Off19_g52288;
				#endif
				half3 ObjectData20_g52289 = staticSwitch14_g52288;
				half3 WorldData19_g52289 = Off19_g52288;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g52289 = WorldData19_g52289;
				#else
				float3 staticSwitch14_g52289 = ObjectData20_g52289;
				#endif
				float3 temp_output_66_0_g52287 = staticSwitch14_g52289;
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g52287 = ( temp_output_66_0_g52287 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g52287 = temp_output_66_0_g52287;
				#endif
				float temp_output_7_0_g52220 = _SizeFadeEndValue;
				float temp_output_335_0_g51941 = saturate( ( ( ( distance( _WorldSpaceCameraPos , staticSwitch13_g52287 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g52220 ) / ( _SizeFadeStartValue - temp_output_7_0_g52220 ) ) );
				float3 appendResult3482_g51941 = (float3(temp_output_335_0_g51941 , temp_output_335_0_g51941 , temp_output_335_0_g51941));
				float3 lerpResult3556_g51941 = lerp( _Vector5 , appendResult3482_g51941 , _SizeFadeMode);
				half3 ObjectData20_g52246 = lerpResult3556_g51941;
				...
				#endif
				float3 Vertex_SizeFade1740_g51941 = staticSwitch14_g52246;
				float3 normalizeResult2696_g51941 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 break2709_g51941 = cross( normalizeResult2696_g51941 , half3(0,1,0) );
				float3 appendResult2710_g51941 = (float3(-break2709_g51941.z , 0.0 , break2709_g51941.x));
				float3 appendResult2667_g51941 = (float3(inputMesh.ase_color.r , 0.5 , inputMesh.ase_color.r));
				float3 normalizeResult2169_g51941 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				...
				float saferPower2652_g51941 = max( Mask_HView2656_g51941 , 0.0001 );
				half3 Grass_Coverage2661_g51941 = ( ( ( mul( GetWorldToObjectMatrix(), float4( appendResult2710_g51941 , 0.0 ) ).xyz * _PerspectivePushValue ) + ( (appendResult2667_g51941*2.0 + -1.0) * _PerspectiveNoiseValue ) ) * inputMesh.ase_color.a * pow( saferPower2652_g51941 , _PerspectiveAngleValue ) );
				...
				float4 lerpResult2779_g51941 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( inputMesh.ase_color.a - temp_output_7_0_g52211 ) / ( _GradientMaxValue - temp_output_7_0_g52211 ) ) ));
				...
				half Noise_Mask3162_g51941 = saturate( ( ( SAMPLE_TEXTURE3D_LOD( TVE_WorldTex3D, samplerTVE_WorldTex3D, ( temp_cast_24 * PositionWS_PerVertex3905_g51941 * 0.1 ), 0.0 ).r - temp_output_7_0_g52236 ) / ( _NoiseMaxValue - temp_output_7_0_g52236 ) ) );
				...
				half Global_NoiseTex_H2869_g51941 = pow( abs( tex2DNode75_g52296.a ) , lerpResult169_g52296 );
				half3 Highlight_Tint3231_g51941 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g51941 * Wind_Power_103106_g51941 * inputMesh.ase_color.r * inputMesh.ase_color.a ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g52207 = Highlight_Tint3231_g51941;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag11_g52207;
				float2 vertexToFrag11_g52308 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = vertexToFrag11_g52308;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g51941;
				
				float2 vertexToFrag11_g52248 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.zw = vertexToFrag11_g52248;
						...
						)
			{
				...
				float3 vertexToFrag11_g52207 = packedInput.ase_texcoord7.xyz;
				float2 vertexToFrag11_g52308 = packedInput.ase_texcoord8.xy;
				...
				half3 Blend_AlbedoTinted2808_g51941 = ( vertexToFrag11_g52235 * vertexToFrag11_g52230 * vertexToFrag11_g52207 * Blend_Albedo265_g51941 );
				...
				float3 vertexToFrag3890_g51941 = packedInput.ase_texcoord9.xyz;
				float3 PositionWS_PerVertex3905_g51941 = vertexToFrag3890_g51941;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g51941;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				...
				float3 temp_output_1953_0_g51941 = ( Global_ColorsTex_RGB1700_g51941 * 4.594794 );
				half3 Global_Colors1954_g51941 = temp_output_1953_0_g51941;
				float lerpResult3870_g51941 = lerp( 1.0 , packedInput.ase_color.r , _ColorsVariationValue);
				half Global_Colors_Value3650_g51941 = ( _GlobalColors * lerpResult3870_g51941 );
				float temp_output_7_0_g52233 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g51941 = saturate( ( ( ( 1.0 - packedInput.ase_color.a ) - temp_output_7_0_g52233 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g52233 ) ) );
				...
				half Subsurface_Mask1557_g51941 = saturate( ( ( packedInput.ase_color.a - temp_output_7_0_g52237 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g52237 ) ) );
				...
				float lerpResult1065_g51941 = lerp( 1.0 , packedInput.ase_color.r , _OverlayVariationValue);
				...
				half Overlay_Mask269_g51941 = saturate( ( ( ( ( ( packedInput.ase_color.a * 0.5 ) + Main_AlbedoTex_G3526_g51941 ) * Overlay_Commons1365_g51941 ) - temp_output_7_0_g52234 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g52234 ) ) );
				...
				float Mesh_Occlusion318_g51941 = packedInput.ase_color.g;
				float temp_output_7_0_g52232 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g51941 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , saturate( ( ( Mesh_Occlusion318_g51941 - temp_output_7_0_g52232 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g52232 ) ) ));
				...
				float3 hdEmission4189_g51941 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g52248 = packedInput.ase_texcoord8.zw;
				...
				half3 Final_Emissive2476_g51941 = ( (( hdEmission4189_g51941 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51941 ) )).rgb * lerpResult4206_g51941 );
				...
				surfaceDescription.Albedo = ( Final_Albedo359_g51941 * Vertex_Occlusion648_g51941 );
				surfaceDescription.Normal = Final_Normal366_g51941;
				...
				surfaceDescription.Emission = Final_Emissive2476_g51941;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g51941;
				surfaceDescription.Occlusion = Blend_Occlusion323_g51941;
				surfaceDescription.Alpha = Final_Clip914_g51941;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				half3 _Vector1 = half3(0,0,0);
				half3 Off19_g52249 = _Vector1;
				float3 appendResult2827_g51941 = (float3(inputMesh.uv0.z , inputMesh.ase_texcoord3.w , inputMesh.uv0.w));
				half3 Mesh_PivotsData2831_g51941 = ( appendResult2827_g51941 * _VertexPivotMode );
				half3 On20_g52249 = Mesh_PivotsData2831_g51941;
				#ifdef TVE_PIVOT_DATA_BAKED
				float3 staticSwitch14_g52249 = On20_g52249;
				...
				float3 localObjectPosition_UNITY_MATRIX_M14_g52287 = ObjectPosition_UNITY_MATRIX_M();
				half3 Off19_g52288 = localObjectPosition_UNITY_MATRIX_M14_g52287;
				float3 appendResult93_g52287 = (float3(inputMesh.uv0.z , inputMesh.ase_texcoord3.w , inputMesh.uv0.w));
				float3 temp_output_91_0_g52287 = ( appendResult93_g52287 * _vertex_pivot_mode );
				float3 PivotsOnly105_g52287 = (mul( GetObjectToWorldMatrix(), float4( temp_output_91_0_g52287 , 0.0 ) ).xyz).xyz;
				half3 On20_g52288 = ( localObjectPosition_UNITY_MATRIX_M14_g52287 + PivotsOnly105_g52287 );
				#ifdef TVE_PIVOT_DATA_BAKED
				...
				half3 Highlight_Tint3231_g51941 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g51941 * Wind_Power_103106_g51941 * inputMesh.ase_color.r * inputMesh.ase_color.a ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g52207 = Highlight_Tint3231_g51941;
				outputPackedVaryingsMeshToPS.ase_texcoord2.xyz = vertexToFrag11_g52207;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g51941;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.zw = vertexToFrag11_g52248;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 vertexToFrag11_g52207 = packedInput.ase_texcoord2.xyz;
				...
				half Global_Colors_Influence3668_g51941 = vertexToFrag11_g52229;
				float3 lerpResult3618_g51941 = lerp( Blend_AlbedoTinted2808_g51941 , temp_cast_0 , Global_Colors_Influence3668_g51941);
				float3 vertexToFrag3890_g51941 = packedInput.ase_texcoord4.xyz;
				float3 PositionWS_PerVertex3905_g51941 = vertexToFrag3890_g51941;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g51941;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				float4 lerpResult88_g52222 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g52222).xz ) ),temp_output_82_0_g52222 ) , TVE_ColorsUsage[(int)temp_output_82_0_g52222]);
				...
				float3 hdEmission4189_g51941 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g52248 = packedInput.ase_texcoord3.zw;
				half2 Emissive_UVs2468_g51941 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g51941 = break89_g52261.r;
				float lerpResult4206_g51941 = lerp( 1.0 , Global_Extras_Emissive4203_g51941 , _GlobalEmissive);
				half3 Final_Emissive2476_g51941 = ( (( hdEmission4189_g51941 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51941 ) )).rgb * lerpResult4206_g51941 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag3890_g51941 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord1.xyz = vertexToFrag3890_g51941;
				float2 vertexToFrag11_g52308 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
					...
					)
			{
				...
				half Final_AlphaFade3727_g51941 = 1.0;
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g51941;
				float3 vertexToFrag3890_g51941 = packedInput.ase_texcoord1.xyz;
				float3 PositionWS_PerVertex3905_g51941 = vertexToFrag3890_g51941;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				half3 Highlight_Tint3231_g51941 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g51941 * Wind_Power_103106_g51941 * inputMesh.ase_color.r * inputMesh.ase_color.a ) + float3( 1,1,1 ) );
				float3 vertexToFrag11_g52207 = Highlight_Tint3231_g51941;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag11_g52207;
				float2 vertexToFrag11_g52308 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord10.xy = vertexToFrag11_g52308;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g51941;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				float4 lerpResult88_g52222 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g52222).xz ) ),temp_output_82_0_g52222, 0.0 ) , TVE_ColorsUsage[(int)temp_output_82_0_g52222]);
				half Global_ColorsTex_A1701_g51941 = (lerpResult88_g52222).a;
				...
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag3890_g51941;
				
				float2 vertexToFrag11_g52248 = ( ( inputMesh.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord10.zw = vertexToFrag11_g52248;
						...
						)
			{
				...
				float3 vertexToFrag11_g52207 = packedInput.ase_texcoord9.xyz;
				float2 vertexToFrag11_g52308 = packedInput.ase_texcoord10.xy;
				half2 Main_UVs15_g51941 = vertexToFrag11_g52308;
				float4 tex2DNode29_g51941 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51941 );
				float3 temp_output_51_0_g51941 = ( (_MainColor).rgb * (tex2DNode29_g51941).rgb );
				half3 Main_Albedo99_g51941 = temp_output_51_0_g51941;
				...
				half Global_Colors_Influence3668_g51941 = vertexToFrag11_g52229;
				float3 lerpResult3618_g51941 = lerp( Blend_AlbedoTinted2808_g51941 , temp_cast_0 , Global_Colors_Influence3668_g51941);
				float3 vertexToFrag3890_g51941 = packedInput.ase_texcoord11.xyz;
				float3 PositionWS_PerVertex3905_g51941 = vertexToFrag3890_g51941;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g51941;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				float4 lerpResult88_g52222 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g52222).xz ) ),temp_output_82_0_g52222 ) , TVE_ColorsUsage[(int)temp_output_82_0_g52222]);
				...
				float3 hdEmission4189_g51941 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g52248 = packedInput.ase_texcoord10.zw;
				half2 Emissive_UVs2468_g51941 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g51941 = break89_g52261.r;
				float lerpResult4206_g51941 = lerp( 1.0 , Global_Extras_Emissive4203_g51941 , _GlobalEmissive);
				half3 Final_Emissive2476_g51941 = ( (( hdEmission4189_g51941 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51941 ) )).rgb * lerpResult4206_g51941 );
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2680.206;895.8101;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;603;-1600,384;Inherit;False;Define PIPELINE HD;-1;;52312;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
...
Node;AmplifyShaderEditor.FunctionNode;604;-1344,-896;Inherit;False;Compile All Shaders;-1;;52311;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;535;-1888,384;Inherit;False;Define TVE IS GRASS SHADER;-1;;52310;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;569;-2176,-384;Inherit;False;Base Shader;0;;51941;856f7164d1c579d43a5cf4968a75ca43;80,3882,1,3880,1,3957,1,4028,1,4029,1,3900,1,3903,1,3904,1,4204,1,3908,1,4172,1,1300,1,1298,1,4179,1,3586,0,1271,1,3889,1,3658,1,1708,1,3509,1,1712,0,3873,1,1715,1,1714,1,1717,1,1718,1,916,0,1763,0,1762,0,3568,1,1949,1,1776,1,3475,1,4210,1,893,1,1745,1,3479,0,3501,1,3221,1,1646,1,1757,0,2807,1,3886,0,2953,1,3887,0,3243,1,3888,0,3728,0,3949,0,2172,0,3883,0,2658,1,1742,1,3484,0,1735,0,1736,0,1733,0,1737,0,1734,0,3575,0,878,0,1550,0,4067,0,4068,0,4072,0,4070,0,4069,0,860,1,3544,1,2261,1,2260,1,2032,0,2054,0,2060,0,2036,0,2062,1,2039,1,4177,1,3592,1,2750,1;0;19;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4135;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4127;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
Node;AmplifyShaderEditor.FunctionNode;605;-1536,-896;Inherit;False;Compile Core;-1;;51940;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;534;-2176,384;Inherit;False;Define TVE PIVOT DATA BAKED;-1;;51939;8da5867b3f9f1834693af40d3eff73f4;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=12800A63596DA6807B0214ACE4961B7A8E3AD720
