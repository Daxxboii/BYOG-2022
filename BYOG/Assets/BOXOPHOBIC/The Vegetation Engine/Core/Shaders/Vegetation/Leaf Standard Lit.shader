	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 PositionOS3588_g50725 = inputMesh.positionOS;
				half3 _Vector1 = half3(0,0,0);
				half3 Mesh_PivotsOS2291_g50725 = _Vector1;
				float3 temp_output_2283_0_g50725 = ( PositionOS3588_g50725 - Mesh_PivotsOS2291_g50725 );
				half3 VertexPos40_g52293 = temp_output_2283_0_g50725;
				...
				float Bounds_Radius121_g50725 = _MaxBoundsInfo.x;
				float WorldData19_g52239 = Bounds_Radius121_g50725;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g52239 = WorldData19_g52239;
				#else
				float staticSwitch14_g52239 = ObjectData20_g52239;
				#endif
				float Motion_Max_Rolling1137_g50725 = staticSwitch14_g52239;
				...
				half4 Global_Motion_Params3909_g50725 = lerpResult87_g52277;
				float4 break322_g52303 = Global_Motion_Params3909_g50725;
				half Wind_Power369_g52303 = break322_g52303.z;
				float lerpResult410_g52303 = lerp( 0.2 , 1.0 , Wind_Power369_g52303);
				half Wind_Power_203109_g50725 = lerpResult410_g52303;
				half Mesh_Motion_260_g50725 = inputMesh.ase_texcoord3.y;
				...
				half Wind_Power2223_g50725 = Wind_Power369_g52303;
				float temp_output_167_0_g52296 = Wind_Power2223_g50725;
				...
				half Global_NoiseTex_R34_g50725 = break142_g52296.r;
				...
				#endif
				half Motion_Variation3073_g50725 = staticSwitch14_g52213;
				float temp_output_3154_0_g50725 = ( _MotionVariation_20 * Motion_Variation3073_g50725 );
				float Motion_Variation284_g52276 = temp_output_3154_0_g50725;
				float Motion_Scale287_g52276 = ( _MotionScale_20 * ase_worldPos.x );
				half Variation127_g52292 = temp_output_3154_0_g50725;
				...
				float temp_output_112_0_g52292 = Wind_Power2223_g50725;
				...
				half Motion_Rolling138_g50725 = ( ( _MotionAmplitude_20 * Motion_Max_Rolling1137_g50725 ) * ( Wind_Power_203109_g50725 * Mesh_Motion_260_g50725 * Global_NoiseTex_R34_g50725 * _VertexRollingMode ) * sin( ( mulTime354_g52276 + Motion_Variation284_g52276 + Motion_Scale287_g52276 ) ) * lerpResult126_g52292 );
				half Angle44_g52293 = Motion_Rolling138_g50725;
				...
				float Bounds_Height374_g50725 = _MaxBoundsInfo.y;
				float WorldData19_g52309 = ( Bounds_Height374_g50725 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g52309 = WorldData19_g52309;
				#else
				float staticSwitch14_g52309 = ObjectData20_g52309;
				#endif
				float Motion_Max_Bending1133_g50725 = staticSwitch14_g52309;
				float lerpResult376_g52303 = lerp( 0.1 , 1.0 , Wind_Power369_g52303);
				half Wind_Power_103106_g50725 = lerpResult376_g52303;
				...
				half2 Wind_DirectionOS39_g50725 = (temp_output_339_0_g52303).xz;
				half Input_Speed62_g52219 = _MotionSpeed_10;
				float mulTime373_g52219 = _TimeParameters.x * Input_Speed62_g52219;
				half Motion_Variation284_g52219 = ( _MotionVariation_10 * Motion_Variation3073_g50725 );
				...
				half Input_Turbulence327_g52219 = Global_NoiseTex_R34_g50725;
				float2 lerpResult321_g52219 = lerp( Sine_MinusOneToOne281_g52219 , temp_cast_12 , Input_Turbulence327_g52219);
				half2 Motion_Bending2258_g50725 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g50725 ) * Wind_Power_103106_g50725 * Wind_DirectionOS39_g50725 * Global_NoiseTex_R34_g50725 * lerpResult321_g52219 );
				half Interaction_Amplitude4137_g50725 = _InteractionAmplitude;
				...
				half4 Global_React_Params4173_g50725 = lerpResult87_g52269;
				float4 break322_g52256 = Global_React_Params4173_g50725;
				half Interaction_Mask66_g50725 = break322_g52256.z;
				...
				half2 Interaction_DirectionOS4158_g50725 = (temp_output_339_0_g52256).xz;
				float lerpResult3307_g50725 = lerp( 1.0 , Motion_Variation3073_g50725 , _InteractionVariation);
				half2 Motion_Interaction53_g50725 = ( Interaction_Amplitude4137_g50725 * Motion_Max_Bending1133_g50725 * Interaction_Mask66_g50725 * Interaction_Mask66_g50725 * Interaction_DirectionOS4158_g50725 * lerpResult3307_g50725 );
				float2 lerpResult109_g50725 = lerp( Motion_Bending2258_g50725 , Motion_Interaction53_g50725 , ( Interaction_Mask66_g50725 * saturate( Interaction_Amplitude4137_g50725 ) ));
				half Mesh_Motion_182_g50725 = inputMesh.ase_texcoord3.x;
				float2 break143_g50725 = ( lerpResult109_g50725 * Mesh_Motion_182_g50725 );
				half Motion_Z190_g50725 = break143_g50725.y;
				half Angle44_g52260 = Motion_Z190_g50725;
				...
				half Motion_X216_g50725 = break143_g50725.x;
				half Angle44_g52259 = -Motion_X216_g50725;
				...
				float Motion_Variation330_g52247 = ( _MotionVariation_32 * Motion_Variation3073_g50725 );
				half Input_Amplitude58_g52247 = ( _MotionAmplitude_32 * Bounds_Radius121_g50725 * 0.1 );
				...
				#else
				float3 staticSwitch358_g52247 = ( temp_output_299_0_g52247 * inputMesh.normalOS );
				#endif
				half Global_NoiseTex_A139_g50725 = break142_g52296.a;
				half Mesh_Motion_3144_g50725 = inputMesh.ase_texcoord3.z;
				float lerpResult378_g52303 = lerp( 0.3 , 1.0 , Wind_Power369_g52303);
				half Wind_Power_323115_g50725 = lerpResult378_g52303;
				float temp_output_7_0_g52254 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g50725 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g52254 ) / ( TVE_MotionFadeStart - temp_output_7_0_g52254 ) ) );
				half3 Motion_Detail263_g50725 = ( staticSwitch358_g52247 * ( ( Global_NoiseTex_R34_g50725 + Global_NoiseTex_A139_g50725 ) * Mesh_Motion_3144_g50725 * Wind_Power_323115_g50725 ) * Wind_FadeOut4005_g50725 );
				float3 Vertex_Motion_Object833_g50725 = ( ( VertexPosRotationAxis50_g52259 + ( VertexPosOtherAxis82_g52259 * cos( Angle44_g52259 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g52259 ) * sin( Angle44_g52259 ) ) ) + Motion_Detail263_g50725 );
				float3 temp_output_3474_0_g50725 = ( PositionOS3588_g50725 - Mesh_PivotsOS2291_g50725 );
				float3 appendResult2047_g50725 = (float3(Motion_Rolling138_g50725 , 0.0 , -Motion_Rolling138_g50725));
				float3 appendResult2043_g50725 = (float3(Motion_X216_g50725 , 0.0 , Motion_Z190_g50725));
				float3 Vertex_Motion_World1118_g50725 = ( ( ( temp_output_3474_0_g50725 + appendResult2047_g50725 ) + appendResult2043_g50725 ) + Motion_Detail263_g50725 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g50725 = Vertex_Motion_World1118_g50725;
				#else
				float3 staticSwitch3312_g50725 = ( Vertex_Motion_Object833_g50725 + ( 0.0 * _VertexDataMode ) );
				#endif
				half Global_Vertex_Size174_g50725 = break322_g52256.w;
				float lerpResult346_g50725 = lerp( 1.0 , Global_Vertex_Size174_g50725 , _GlobalSize);
				float3 appendResult3480_g50725 = (float3(lerpResult346_g50725 , lerpResult346_g50725 , lerpResult346_g50725));
				half3 ObjectData20_g52294 = appendResult3480_g50725;
				...
				#endif
				half3 Vertex_Size1741_g50725 = staticSwitch14_g52294;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g50725 = _Vector5;
				half3 Grass_Coverage2661_g50725 = half3(0,0,0);
				float3 Final_VertexPosition890_g50725 = ( ( staticSwitch3312_g50725 * Vertex_Size1741_g50725 * Vertex_SizeFade1740_g50725 ) + Mesh_PivotsOS2291_g50725 + Grass_Coverage2661_g50725 );
				
				float temp_output_7_0_g52211 = _GradientMinValue;
				float4 lerpResult2779_g50725 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( inputMesh.ase_color.a - temp_output_7_0_g52211 ) / ( _GradientMaxValue - temp_output_7_0_g52211 ) ) ));
				half3 Gradient_Tint2784_g50725 = (lerpResult2779_g50725).rgb;
				float3 vertexToFrag11_g52235 = Gradient_Tint2784_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag11_g52235;
				float3 temp_cast_20 = (_NoiseScaleValue).xxx;
				float3 vertexToFrag3890_g50725 = ase_worldPos;
				float3 PositionWS_PerVertex3905_g50725 = vertexToFrag3890_g50725;
				float temp_output_7_0_g52236 = _NoiseMinValue;
				half Noise_Mask3162_g50725 = saturate( ( ( SAMPLE_TEXTURE3D_LOD( TVE_WorldTex3D, samplerTVE_WorldTex3D, ( temp_cast_20 * PositionWS_PerVertex3905_g50725 * 0.1 ), 0.0 ).r - temp_output_7_0_g52236 ) / ( _NoiseMaxValue - temp_output_7_0_g52236 ) ) );
				float4 lerpResult2800_g50725 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask3162_g50725);
				half3 Noise_Tint2802_g50725 = (lerpResult2800_g50725).rgb;
				float3 vertexToFrag11_g52230 = Noise_Tint2802_g50725;
				...
				float3 Position58_g52222 = PositionWS_PerVertex3905_g50725;
				...
				half Global_ColorsTex_A1701_g50725 = (lerpResult88_g52222).a;
				float vertexToFrag11_g52229 = Global_ColorsTex_A1701_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag11_g52229;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag3890_g50725;
				...
				float saferPower3976_g50725 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g52252 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g52252 ) ) ) , 0.0001 );
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord6.w = vertexToFrag11_g52251;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g50725;
						...
						)
			{
				...
				half2 Main_UVs15_g50725 = vertexToFrag11_g52308;
				float4 tex2DNode29_g50725 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g50725 );
				float3 temp_output_51_0_g50725 = ( (_MainColor).rgb * (tex2DNode29_g50725).rgb );
				half3 Main_Albedo99_g50725 = temp_output_51_0_g50725;
				half3 Blend_Albedo265_g50725 = Main_Albedo99_g50725;
				half3 Blend_AlbedoTinted2808_g50725 = ( vertexToFrag11_g52235 * vertexToFrag11_g52230 * float3(1,1,1) * Blend_Albedo265_g50725 );
				float dotResult3616_g50725 = dot( Blend_AlbedoTinted2808_g50725 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g50725).xxx;
				float vertexToFrag11_g52229 = packedInput.ase_texcoord5.w;
				half Global_Colors_Influence3668_g50725 = vertexToFrag11_g52229;
				float3 lerpResult3618_g50725 = lerp( Blend_AlbedoTinted2808_g50725 , temp_cast_0 , Global_Colors_Influence3668_g50725);
				float3 vertexToFrag3890_g50725 = packedInput.ase_texcoord8.xyz;
				float3 PositionWS_PerVertex3905_g50725 = vertexToFrag3890_g50725;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g50725;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				...
				half3 Global_ColorsTex_RGB1700_g50725 = (lerpResult88_g52222).rgb;
				float3 temp_output_1953_0_g50725 = ( Global_ColorsTex_RGB1700_g50725 * 4.594794 );
				half3 Global_Colors1954_g50725 = temp_output_1953_0_g50725;
				float lerpResult3870_g50725 = lerp( 1.0 , packedInput.ase_color.r , _ColorsVariationValue);
				half Global_Colors_Value3650_g50725 = ( _GlobalColors * lerpResult3870_g50725 );
				float4 tex2DNode35_g50725 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g50725 );
				half Main_Mask57_g50725 = tex2DNode35_g50725.b;
				float temp_output_7_0_g52233 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g50725 = saturate( ( ( Main_Mask57_g50725 - temp_output_7_0_g52233 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g52233 ) ) );
				float3 lerpResult3628_g50725 = lerp( Blend_AlbedoTinted2808_g50725 , ( lerpResult3618_g50725 * Global_Colors1954_g50725 ) , ( Global_Colors_Value3650_g50725 * Global_Colors_Mask3692_g50725 ));
				half3 Blend_AlbedoColored863_g50725 = lerpResult3628_g50725;
				float3 temp_output_799_0_g50725 = (_SubsurfaceColor).rgb;
				float dotResult3930_g50725 = dot( temp_output_799_0_g50725 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g50725).xxx;
				float3 lerpResult3932_g50725 = lerp( temp_output_799_0_g50725 , temp_cast_3 , Global_Colors_Influence3668_g50725);
				float3 lerpResult3942_g50725 = lerp( temp_output_799_0_g50725 , ( lerpResult3932_g50725 * Global_Colors1954_g50725 ) , ( Global_Colors_Value3650_g50725 * Global_Colors_Mask3692_g50725 ));
				half3 Subsurface_Color1722_g50725 = lerpResult3942_g50725;
				half MainLight_Subsurface4041_g50725 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g50725 = ( _SubsurfaceValue * MainLight_Subsurface4041_g50725 );
				float temp_output_7_0_g52237 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g50725 = saturate( ( ( Main_Mask57_g50725 - temp_output_7_0_g52237 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g52237 ) ) );
				half3 Subsurface_Transmission884_g50725 = ( Subsurface_Color1722_g50725 * Subsurface_Intensity1752_g50725 * Subsurface_Mask1557_g50725 );
				half3 MainLight_Direction3926_g50725 = TVE_MainLightDirection;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 normalizeResult2169_g50725 = normalize( ( _WorldSpaceCameraPos - ase_worldPos ) );
				float3 ViewDir_Normalized3963_g50725 = normalizeResult2169_g50725;
				float dotResult785_g50725 = dot( -MainLight_Direction3926_g50725 , ViewDir_Normalized3963_g50725 );
				float saferPower1624_g50725 = max( (dotResult785_g50725*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g50725 = 0.0;
				#else
				float staticSwitch1602_g50725 = ( pow( saferPower1624_g50725 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g50725 = staticSwitch1602_g50725;
				float3 unpack4112_g50725 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g50725 ), _MainNormalValue );
				unpack4112_g50725.z = lerp( 1, unpack4112_g50725.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g50725 = unpack4112_g50725;
				...
				float3 tanNormal4099_g50725 = Main_Normal137_g50725;
				float3 worldNormal4099_g50725 = float3(dot(tanToWorld0,tanNormal4099_g50725), dot(tanToWorld1,tanNormal4099_g50725), dot(tanToWorld2,tanNormal4099_g50725));
				float3 Main_Normal_WS4101_g50725 = worldNormal4099_g50725;
				float dotResult777_g50725 = dot( MainLight_Direction3926_g50725 , Main_Normal_WS4101_g50725 );
				float lerpResult4198_g50725 = lerp( 1.0 , saturate( dotResult777_g50725 ) , _MainLightNormalValue);
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1604_g50725 = 0.0;
				#else
				float staticSwitch1604_g50725 = lerpResult4198_g50725;
				#endif
				half Mask_Subsurface_Normal870_g50725 = staticSwitch1604_g50725;
				half3 Subsurface_Scattering1693_g50725 = ( Subsurface_Transmission884_g50725 * Blend_AlbedoColored863_g50725 * Mask_Subsurface_View782_g50725 * Mask_Subsurface_Normal870_g50725 );
				half3 Blend_AlbedoAndSubsurface149_g50725 = ( Blend_AlbedoColored863_g50725 + Subsurface_Scattering1693_g50725 );
				half3 Global_OverlayColor1758_g50725 = (TVE_OverlayColor).rgb;
				float lerpResult3567_g50725 = lerp( _OverlayBottomValue , 1.0 , Main_Normal_WS4101_g50725.y);
				half Main_AlbedoTex_G3526_g50725 = tex2DNode29_g50725.g;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g50725;
				...
				half Global_Extras_Overlay156_g50725 = break89_g52261.b;
				float temp_output_1025_0_g50725 = ( _GlobalOverlay * Global_Extras_Overlay156_g50725 );
				float lerpResult1065_g50725 = lerp( 1.0 , packedInput.ase_color.r , _OverlayVariationValue);
				half Overlay_Commons1365_g50725 = ( temp_output_1025_0_g50725 * lerpResult1065_g50725 );
				float temp_output_7_0_g52234 = _OverlayMaskMinValue;
				half Overlay_Mask269_g50725 = saturate( ( ( ( ( ( lerpResult3567_g50725 * 0.5 ) + Main_AlbedoTex_G3526_g50725 ) * Overlay_Commons1365_g50725 ) - temp_output_7_0_g52234 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g52234 ) ) );
				float3 lerpResult336_g50725 = lerp( Blend_AlbedoAndSubsurface149_g50725 , Global_OverlayColor1758_g50725 , Overlay_Mask269_g50725);
				half3 Final_Albedo359_g50725 = lerpResult336_g50725;
				float3 temp_cast_7 = (1.0).xxx;
				float Mesh_Occlusion318_g50725 = packedInput.ase_color.g;
				float temp_output_7_0_g52232 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g50725 = lerp( (_VertexOcclusionColor).rgb , temp_cast_7 , saturate( ( ( Mesh_Occlusion318_g50725 - temp_output_7_0_g52232 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g52232 ) ) ));
				float3 Vertex_Occlusion648_g50725 = lerpResult2945_g50725;
				
				float3 temp_output_13_0_g52210 = Main_Normal137_g50725;
				float3 switchResult12_g52210 = (((isFrontFace>0)?(temp_output_13_0_g52210):(( temp_output_13_0_g52210 * _render_normals_options ))));
				half3 Blend_Normal312_g50725 = switchResult12_g52210;
				half3 Final_Normal366_g50725 = Blend_Normal312_g50725;
				
				float3 temp_cast_8 = (( 0.04 * _RenderSpecular )).xxx;
				
				float3 hdEmission4189_g50725 = ASEGetEmissionHDRColor(_EmissiveColor.rgb,_EmissiveIntensityParams.x,_EmissiveExposureValue,GetInverseCurrentExposureMultiplier());
				float2 vertexToFrag11_g52248 = packedInput.ase_texcoord7.zw;
				half2 Emissive_UVs2468_g50725 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g50725 = break89_g52261.r;
				float lerpResult4206_g50725 = lerp( 1.0 , Global_Extras_Emissive4203_g50725 , _GlobalEmissive);
				half3 Final_Emissive2476_g50725 = ( (( hdEmission4189_g50725 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g50725 ) )).rgb * lerpResult4206_g50725 );
				
				half Main_Smoothness227_g50725 = ( tex2DNode35_g50725.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g50725 = Main_Smoothness227_g50725;
				half Global_OverlaySmoothness311_g50725 = TVE_OverlaySmoothness;
				float lerpResult343_g50725 = lerp( Blend_Smoothness314_g50725 , Global_OverlaySmoothness311_g50725 , Overlay_Mask269_g50725);
				half Final_Smoothness371_g50725 = lerpResult343_g50725;
				half Global_Extras_Wetness305_g50725 = break89_g52261.g;
				float lerpResult3673_g50725 = lerp( 0.0 , Global_Extras_Wetness305_g50725 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g50725 = saturate( ( Final_Smoothness371_g50725 + lerpResult3673_g50725 ) );
				
				float lerpResult240_g50725 = lerp( 1.0 , tex2DNode35_g50725.g , _MainOcclusionValue);
				half Main_Occlusion247_g50725 = lerpResult240_g50725;
				half Blend_Occlusion323_g50725 = Main_Occlusion247_g50725;
				
				float localCustomAlphaClip3735_g50725 = ( 0.0 );
				float3 normalizeResult3971_g50725 = normalize( cross( ddy( ase_worldPos ) , ddx( ase_worldPos ) ) );
				float3 NormalsWS_Derivates3972_g50725 = normalizeResult3971_g50725;
				float dotResult3851_g50725 = dot( ViewDir_Normalized3963_g50725 , NormalsWS_Derivates3972_g50725 );
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g52251 = packedInput.ase_texcoord6.w;
				half Fade_Camera3743_g50725 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
				float Mesh_Variation16_g50725 = packedInput.ase_color.r;
				float temp_output_4023_0_g50725 = (Mesh_Variation16_g50725*0.5 + 0.5);
				half Global_Extras_Alpha1033_g50725 = break89_g52261.a;
				float temp_output_4022_0_g50725 = ( temp_output_4023_0_g50725 - ( 1.0 - Global_Extras_Alpha1033_g50725 ) );
				half AlphaTreshold2132_g50725 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch4017_g50725 = ( temp_output_4022_0_g50725 + AlphaTreshold2132_g50725 );
				#else
				float staticSwitch4017_g50725 = temp_output_4022_0_g50725;
				#endif
				float lerpResult4011_g50725 = lerp( 1.0 , staticSwitch4017_g50725 , _GlobalAlpha);
				half Global_Alpha315_g50725 = saturate( lerpResult4011_g50725 );
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g50725 = ( ( Main_Alpha316_g50725 * Global_Alpha315_g50725 ) - ( AlphaTreshold2132_g50725 - 0.5 ) );
				#else
				float staticSwitch3792_g50725 = ( Main_Alpha316_g50725 * Global_Alpha315_g50725 );
				#endif
				half Final_Alpha3754_g50725 = staticSwitch3792_g50725;
				float temp_output_661_0_g50725 = ( saturate( ( temp_output_41_0_g52255 + ( temp_output_41_0_g52255 * SAMPLE_TEXTURE3D( TVE_ScreenTex3D, samplerTVE_ScreenTex3D, ( TVE_ScreenTexCoord * PositionWS_PerVertex3905_g50725 ) ).r ) ) ) * Final_Alpha3754_g50725 );
				float Alpha3735_g50725 = temp_output_661_0_g50725;
				float Treshold3735_g50725 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g50725 - Treshold3735_g50725);
				#endif
				}
				half Final_Clip914_g50725 = saturate( Alpha3735_g50725 );
				
				surfaceDescription.Albedo = ( Final_Albedo359_g50725 * Vertex_Occlusion648_g50725 );
				surfaceDescription.Normal = Final_Normal366_g50725;
				...
				surfaceDescription.Emission = Final_Emissive2476_g50725;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g50725;
				surfaceDescription.Occlusion = Blend_Occlusion323_g50725;
				surfaceDescription.Alpha = Final_Clip914_g50725;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag3890_g50725;
				...
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord1.w = vertexToFrag11_g52251;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half Global_Colors_Influence3668_g50725 = vertexToFrag11_g52229;
				float3 lerpResult3618_g50725 = lerp( Blend_AlbedoTinted2808_g50725 , temp_cast_0 , Global_Colors_Influence3668_g50725);
				float3 vertexToFrag3890_g50725 = packedInput.ase_texcoord3.xyz;
				float3 PositionWS_PerVertex3905_g50725 = vertexToFrag3890_g50725;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g50725;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				float4 lerpResult88_g52222 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g52222).xz ) ),temp_output_82_0_g52222 ) , TVE_ColorsUsage[(int)temp_output_82_0_g52222]);
				...
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g52251 = packedInput.ase_texcoord1.w;
				half Fade_Camera3743_g50725 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord1.x = vertexToFrag11_g52251;
				float3 vertexToFrag3890_g50725 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord1.yzw = vertexToFrag3890_g50725;
				float2 vertexToFrag11_g52308 = ( ( inputMesh.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord2.xy = vertexToFrag11_g52308;
					...
					)
			{
				...
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g52251 = packedInput.ase_texcoord1.x;
				half Fade_Camera3743_g50725 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50725;
				float3 vertexToFrag3890_g50725 = packedInput.ase_texcoord1.yzw;
				float3 PositionWS_PerVertex3905_g50725 = vertexToFrag3890_g50725;
				float2 vertexToFrag11_g52308 = packedInput.ase_texcoord2.xy;
				half2 Main_UVs15_g50725 = vertexToFrag11_g52308;
				float4 tex2DNode29_g50725 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g50725 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 vertexToFrag3890_g50725 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag3890_g50725;
				
				float temp_output_7_0_g52252 = TVE_CameraFadeStart;
				float saferPower3976_g50725 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g52252 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g52252 ) ) ) , 0.0001 );
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord3.z = vertexToFrag11_g52251;
					...
					)
			{
				...
				float4 tex2DNode29_g50725 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g50725 );
				half Main_AlbedoTex_G3526_g50725 = tex2DNode29_g50725.g;
				float3 vertexToFrag3890_g50725 = packedInput.ase_texcoord5.xyz;
				float3 PositionWS_PerVertex3905_g50725 = vertexToFrag3890_g50725;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g50725;
				float temp_output_84_0_g52261 = _LayerExtrasValue;
				float4 lerpResult88_g52261 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g52261).xz ) ),temp_output_84_0_g52261 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g52261]);
				...
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g52251 = packedInput.ase_texcoord3.z;
				half Fade_Camera3743_g50725 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float3 vertexToFrag3890_g50725 = ase_worldPos;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag3890_g50725;
				...
				)
			{
				...
				float4 tex2DNode29_g50725 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g50725 );
				half Main_AlbedoTex_G3526_g50725 = tex2DNode29_g50725.g;
				float3 vertexToFrag3890_g50725 = packedInput.ase_texcoord7.xyz;
				float3 PositionWS_PerVertex3905_g50725 = vertexToFrag3890_g50725;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g50725;
				float temp_output_84_0_g52261 = _LayerExtrasValue;
				float4 lerpResult88_g52261 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g52261).xz ) ),temp_output_84_0_g52261 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g52261]);
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag3890_g50725;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 ase_worldTangent = TransformObjectToWorldDir(inputMesh.tangentOS.xyz);
				float ase_vertexTangentSign = inputMesh.tangentOS.w * unity_WorldTransformParams.w;
				float3 ase_worldBitangent = cross( ase_worldNormal, ase_worldTangent ) * ase_vertexTangentSign;
				...
				float temp_output_3976_0_g50725 = pow( saferPower3976_g50725 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50725;
				outputPackedVaryingsMeshToPS.ase_texcoord8.w = vertexToFrag11_g52251;
						...
						)
			{
				...
				half Global_Colors_Influence3668_g50725 = vertexToFrag11_g52229;
				float3 lerpResult3618_g50725 = lerp( Blend_AlbedoTinted2808_g50725 , temp_cast_0 , Global_Colors_Influence3668_g50725);
				float3 vertexToFrag3890_g50725 = packedInput.ase_texcoord10.xyz;
				float3 PositionWS_PerVertex3905_g50725 = vertexToFrag3890_g50725;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g50725;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				float4 lerpResult88_g52222 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g52222).xz ) ),temp_output_82_0_g52222 ) , TVE_ColorsUsage[(int)temp_output_82_0_g52222]);
				...
				float lerpResult3993_g50725 = lerp( 1.0 , abs( dotResult3851_g50725 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g50725 = lerpResult3993_g50725;
				float vertexToFrag11_g52251 = packedInput.ase_texcoord8.w;
				half Fade_Camera3743_g50725 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50725 = ( Fade_Glancing3853_g50725 * Fade_Camera3743_g50725 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50725;
				float Main_Alpha316_g50725 = ( _MainColor.a * tex2DNode29_g50725.a );
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2786.557;728.075;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;660;-1344,-896;Inherit;False;Compile All Shaders;-1;;50723;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;661;-1536,-896;Inherit;False;Compile Core;-1;;52311;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2DF0CE96FEF7CBE7E46C1F19E7065C4DD8499078
