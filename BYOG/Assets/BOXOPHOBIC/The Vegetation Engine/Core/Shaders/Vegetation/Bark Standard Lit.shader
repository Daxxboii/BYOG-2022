	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 VertexPos40_g52293 = temp_output_2283_0_g50723;
				...
				float WorldData19_g52239 = Bounds_Radius121_g50723;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g52239 = WorldData19_g52239;
				#else
				float staticSwitch14_g52239 = ObjectData20_g52239;
				#endif
				float Motion_Max_Rolling1137_g50723 = staticSwitch14_g52239;
				...
				half4 Global_Motion_Params3909_g50723 = lerpResult87_g52277;
				float4 break322_g52303 = Global_Motion_Params3909_g50723;
				half Wind_Power369_g52303 = break322_g52303.z;
				float lerpResult410_g52303 = lerp( 0.2 , 1.0 , Wind_Power369_g52303);
				half Wind_Power_203109_g50723 = lerpResult410_g52303;
				...
				half Wind_Power2223_g50723 = Wind_Power369_g52303;
				float temp_output_167_0_g52296 = Wind_Power2223_g50723;
				...
				half Global_NoiseTex_R34_g50723 = break142_g52296.r;
				...
				#endif
				half Motion_Variation3073_g50723 = staticSwitch14_g52213;
				float temp_output_3154_0_g50723 = ( _MotionVariation_20 * Motion_Variation3073_g50723 );
				float Motion_Variation284_g52276 = temp_output_3154_0_g50723;
				float Motion_Scale287_g52276 = ( _MotionScale_20 * ase_worldPos.x );
				half Variation127_g52292 = temp_output_3154_0_g50723;
				...
				float temp_output_112_0_g52292 = Wind_Power2223_g50723;
				...
				half Motion_Rolling138_g50723 = ( ( _MotionAmplitude_20 * Motion_Max_Rolling1137_g50723 ) * ( Wind_Power_203109_g50723 * Mesh_Motion_260_g50723 * Global_NoiseTex_R34_g50723 * _VertexRollingMode ) * sin( ( mulTime354_g52276 + Motion_Variation284_g52276 + Motion_Scale287_g52276 ) ) * lerpResult126_g52292 );
				half Angle44_g52293 = Motion_Rolling138_g50723;
				...
				float WorldData19_g52309 = ( Bounds_Height374_g50723 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g52309 = WorldData19_g52309;
				#else
				float staticSwitch14_g52309 = ObjectData20_g52309;
				#endif
				float Motion_Max_Bending1133_g50723 = staticSwitch14_g52309;
				float lerpResult376_g52303 = lerp( 0.1 , 1.0 , Wind_Power369_g52303);
				half Wind_Power_103106_g50723 = lerpResult376_g52303;
				...
				half2 Wind_DirectionOS39_g50723 = (temp_output_339_0_g52303).xz;
				half Input_Speed62_g52219 = _MotionSpeed_10;
				float mulTime373_g52219 = _TimeParameters.x * Input_Speed62_g52219;
				half Motion_Variation284_g52219 = ( _MotionVariation_10 * Motion_Variation3073_g50723 );
				...
				half Input_Turbulence327_g52219 = Global_NoiseTex_R34_g50723;
				float2 lerpResult321_g52219 = lerp( Sine_MinusOneToOne281_g52219 , temp_cast_12 , Input_Turbulence327_g52219);
				half2 Motion_Bending2258_g50723 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g50723 ) * Wind_Power_103106_g50723 * Wind_DirectionOS39_g50723 * Global_NoiseTex_R34_g50723 * lerpResult321_g52219 );
				...
				half4 Global_React_Params4173_g50723 = lerpResult87_g52269;
				float4 break322_g52256 = Global_React_Params4173_g50723;
				half Interaction_Mask66_g50723 = break322_g52256.z;
				...
				half2 Interaction_DirectionOS4158_g50723 = (temp_output_339_0_g52256).xz;
				...
				half Angle44_g52260 = Motion_Z190_g50723;
				...
				half Angle44_g52259 = -Motion_X216_g50723;
				float3 Vertex_Motion_Object833_g50723 = ( VertexPosRotationAxis50_g52259 + ( VertexPosOtherAxis82_g52259 * cos( Angle44_g52259 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g52259 ) * sin( Angle44_g52259 ) ) );
				...
				#endif
				half Global_Vertex_Size174_g50723 = break322_g52256.w;
				...
				half3 ObjectData20_g52294 = appendResult3480_g50723;
				...
				#endif
				half3 Vertex_Size1741_g50723 = staticSwitch14_g52294;
				...
				float2 appendResult21_g52242 = (float2(inputMesh.ase_texcoord.z , inputMesh.ase_texcoord.w));
				float2 Mesh_DetailCoord3_g50723 = appendResult21_g52242;
				float2 vertexToFrag11_g52243 = ( ( Mesh_DetailCoord3_g50723 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord5.zw = vertexToFrag11_g52243;
				half Mesh_DetailMask90_g50723 = inputMesh.ase_color.b;
				float vertexToFrag11_g52208 = ( ( Mesh_DetailMask90_g50723 - 0.5 ) + _DetailMeshValue );
				...
				float saferPower3976_g50723 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g52252 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g52252 ) ) ) , 0.0001 );
				float temp_output_3976_0_g50723 = pow( saferPower3976_g50723 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50723;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = vertexToFrag11_g52251;
						...
						)
			{
				...
				half2 Main_UVs15_g50723 = vertexToFrag11_g52308;
				...
				half2 Second_UVs17_g50723 = vertexToFrag11_g52243;
				...
				float temp_output_3919_0_g50723 = vertexToFrag11_g52208;
				...
				half Mask_Detail147_g50723 = saturate( ( ( saturate( ( Blend_Source1540_g50723 + ( Blend_Source1540_g50723 * lerpResult4058_g50723 ) ) ) - temp_output_7_0_g52238 ) / ( _DetailBlendMaxValue - temp_output_7_0_g52238 ) ) );
				...
				float3 Position82_g52261 = PositionWS_PerVertex3905_g50723;
				...
				half Global_Extras_Overlay156_g50723 = break89_g52261.b;
				...
				half Overlay_Mask269_g50723 = saturate( ( ( ( ( ( lerpResult3567_g50723 * 0.5 ) + staticSwitch3574_g50723 ) * Overlay_Commons1365_g50723 ) - temp_output_7_0_g52234 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g52234 ) ) );
				...
				float3 lerpResult2945_g50723 = lerp( (_VertexOcclusionColor).rgb , temp_cast_3 , saturate( ( ( Mesh_Occlusion318_g50723 - temp_output_7_0_g52232 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g52232 ) ) ));
				...
				half2 Emissive_UVs2468_g50723 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g50723 = break89_g52261.r;
				float lerpResult4206_g50723 = lerp( 1.0 , Global_Extras_Emissive4203_g50723 , _GlobalEmissive);
				half3 Final_Emissive2476_g50723 = ( (( hdEmission4189_g50723 * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g50723 ) )).rgb * lerpResult4206_g50723 );
				...
				half Global_Extras_Wetness305_g50723 = break89_g52261.g;
				...
				float vertexToFrag11_g52251 = packedInput.ase_texcoord7.w;
				half Fade_Camera3743_g50723 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50723 = ( 1.0 * Fade_Camera3743_g50723 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50723;
				...
				float temp_output_661_0_g50723 = ( saturate( ( temp_output_41_0_g52255 + ( temp_output_41_0_g52255 * SAMPLE_TEXTURE3D( TVE_ScreenTex3D, samplerTVE_ScreenTex3D, ( TVE_ScreenTexCoord * PositionWS_PerVertex3905_g50723 ) ).r ) ) ) * Final_Alpha3754_g50723 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 appendResult21_g52242 = (float2(inputMesh.uv0.z , inputMesh.uv0.w));
				float2 Mesh_DetailCoord3_g50723 = appendResult21_g52242;
				float2 vertexToFrag11_g52243 = ( ( Mesh_DetailCoord3_g50723 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				...
				float temp_output_3976_0_g50723 = pow( saferPower3976_g50723 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50723;
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = vertexToFrag11_g52251;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float localCustomAlphaClip3735_g50723 = ( 0.0 );
				float vertexToFrag11_g52251 = packedInput.ase_texcoord2.w;
				half Fade_Camera3743_g50723 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50723 = ( 1.0 * Fade_Camera3743_g50723 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50723;
				float Main_Alpha316_g50723 = ( _MainColor.a * tex2DNode29_g50723.a );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float temp_output_3976_0_g50723 = pow( saferPower3976_g50723 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50723;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag11_g52251;
					...
					)
			{
				...
				float localCustomAlphaClip3735_g50723 = ( 0.0 );
				float vertexToFrag11_g52251 = packedInput.ase_texcoord5.w;
				half Fade_Camera3743_g50723 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50723 = ( 1.0 * Fade_Camera3743_g50723 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50723;
				float Main_Alpha316_g50723 = ( _MainColor.a * tex2DNode29_g50723.a );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float temp_output_3976_0_g50723 = pow( saferPower3976_g50723 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g50723;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = vertexToFrag11_g52251;
						...
						)
			{
				...
				float localCustomAlphaClip3735_g50723 = ( 0.0 );
				float vertexToFrag11_g52251 = packedInput.ase_texcoord9.w;
				half Fade_Camera3743_g50723 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g50723 = ( 1.0 * Fade_Camera3743_g50723 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g50723;
				float Main_Alpha316_g50723 = ( _MainColor.a * tex2DNode29_g50723.a );
...
Node;AmplifyShaderEditor.FunctionNode;384;-1536,-896;Inherit;False;Compile Core;-1;;52312;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1864C0BEB2C4078D1E9333C6898C39274F001DC5
